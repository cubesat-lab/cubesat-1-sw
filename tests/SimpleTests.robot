...
*** Keywords ***
Terminate QEMU
    Terminate Process    ${QEMU_PID}    kill=True
...
Start QEMU And Capture Port
    ...
    Sleep    5s    # Adjust the sleep time as needed to ensure QEMU has enough time to start and print the port information
